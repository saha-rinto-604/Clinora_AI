...
public class PatientReportMutationService {
    ...
    public ReportView upload(
        ...
        if (report.subjectType() == PatientReportSubjectType.SELF) {
            timeline.append(
    ...
    public ReportView updateMetadata(
        ...
        if (after.subjectType() == PatientReportSubjectType.SELF
            && (!Objects.equals(before.reportName(), after.reportName())
    ...
    public ReportView archive(UUID patientUserId, UUID reportId, String ipAddress, String userAgent) {
        ...
        if (after.subjectType() == PatientReportSubjectType.SELF && !before.archived() && after.archived()) {
